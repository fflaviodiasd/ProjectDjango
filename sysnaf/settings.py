"""
Django settings for sysnaf project.
...
SECRET_KEY = 'django-insecure-3#h0@8z*f3#o(gw)*mmo2tl+6ff#1y@0_w*s9s0hqg!ix-br3n'
...
WSGI_APPLICATION = 'sysnaf.wsgi.application'
